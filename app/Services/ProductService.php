...
class ProductService
{
    ...
    public function products($request)
    {
        ...
        // $displayOutOfStockProducts = $siteSettings->settings['display_out_of_stock_products'];
        $displayOutOfStockProducts = $siteSettings->settings->display_out_of_stock_products; // Changed from array syntax to object syntax
        ...
        return [
            ...
            'displayOutOfStockProducts' => $displayOutOfStockProducts,
        ];
    }
