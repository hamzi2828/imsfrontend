                    ...
                    <div class="main-content post-single-content">
                        <div class="post post-grid post-single">
                            <figure class="post-media br-sm">
                                <img src="{{ asset('/assets/images/blog/single/1.jpg') }}" alt="Blog" width="930" height="500" />
                            </figure>
                            <div class="post-details">
                                ...
                                <h2 class="post-title"><a href="#">Fashion tells about who you are from external
                                                                   point</a></h2>
                                <div class="post-content">
                                    ...
                                    <p>Morbi purus libero, faucibus adi piscing, com modo quis, gravida iest.
                                       ...
                                       dapibus eu, fermen tum et, dapibus sed, urna. <a href="#">Morbi interdum mollis
                                                                                                 sapien.</a>
                        ...
                        <!-- End Blockquote -->
                        <p class="mb-10">Morbi interdum mollis sapien. Sed ac risus. Pha sellus lacinia, magna a
                                         laoreet, lect us arcu pulvinar risus, vitae fac ilisis libeo dolor.
                                         Sed vel lacus. Mauris nibh felis, adipiscing varius, adipiscing in, lacinia
                                         vel, tellus. Suspendisse ac urna.</p>
                        <h4 class="title title-md font-weight-bold">Defaulting to Mindfulness: The Third Person
                                                                    Effect</h4>
                        <p class="mb-2">Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet
                                        vel,
                                        da pibus id, mattis vel, nisi. Sed pretium, ligula soll itudin laoreet viverra.
                                        Sed lectus.
                                        Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum
                                        volutpat,
                        ...
                        <div class="post-author-detail">
                            <figure class="author-media mr-4">
                                <img src="{{ asset('/assets/images/blog/single/1.png') }}" alt="Author" width="105" height="105" />
                            </figure>
                            <div class="author-details">
                                ...
                                <p class="mb-0">Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismoder eu
                                                ...
                                                Ped earcudaap ibuseu, fermentum et, dapibus sed, urna. Morbi interdum
                                                mollis sapien. </p>
                            </div>
                        </div>
                            ...
                            <div class="post-slider swiper-container swiper-theme nav-top pb-2" data-swiper-options="{
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1">
                                    <div class="swiper-slide post post-grid">
                                        <figure class="post-media br-sm">
                                            <a href="post-single.html">
                                                <img src="{{ asset('/assets/images/blog/single/2.jpg') }}" alt="Post" width="296"
                                        ...
                                        <div class="post-details text-center">
                                            ...
                                            <h4 class="post-title mb-3"><a href="post-single.html">Fashion tell about
                                                                                                   who you are
                                                                                                   from...</a></h4>
                                            <a href="post-single.html"
                                               class="btn btn-link btn-dark btn-underline font-weight-normal">Read
                                                                                                              More<i
                                                        class="w-icon-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide post post-grid">
                                        <figure class="post-media br-sm">
                                            <a href="post-single.html">
                                                <img src="{{ asset('/assets/images/blog/single/3.jpg') }}" alt="Post" width="296"
                                        ...
                                        <div class="post-details text-center">
                                            ...
                                            <h4 class="post-title mb-3"><a href="post-single.html">Comes a cool blog
                                                                                                   post with Images</a>
                                            </h4>
                                            <a href="post-single.html"
                                               class="btn btn-link btn-dark btn-underline font-weight-normal">Read
                                    ...
                                    <div class="swiper-slide post post-grid">
                                        <figure class="post-media br-sm">
                                            <a href="post-single.html">
                                                <img src="{{ asset('/assets/images/blog/single/4.jpg') }}" alt="Post" width="296"
                                    ...
                                    <div class="swiper-slide post post-grid">
                                        <figure class="post-media br-sm">
                                            <a href="post-single.html">
                                                <img src="{{ asset('/assets/images/blog/single/5.jpg') }}" alt="Post" width="296"
                                        ...
                                        <div class="post-details text-center">
                                            ...
                                            <h4 class="post-title mb-3"><a href="post-single.html">We want to be
                                                                                                   different and fashion
                                                                                                   gives to me that
                                                                                                   outlet</a></h4>
                                            <a href="post-single.html"
                                               class="btn btn-link btn-dark btn-underline font-weight-normal">Read
                        ...
                        <ul class="comments list-style-none pl-0">
                            <li class="comment">
                                <div class="comment-body">
                                    <figure class="comment-avatar">
                                        <img src="{{ asset('/assets/images/blog/single/1.png') }}" alt="Avatar" width="90"
                                             height="90" />
                                    </figure>
                                    <div class="comment-content">
                                        ...
                                        <p>Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu
                                           pulvinar nunc sapien ornare nisl.arcu fer
                            ...
                            <li class="comment">
                                <div class="comment-body">
                                    <figure class="comment-avatar">
                                        <img src="{{ asset('/assets/images/blog/single/2.png') }}" alt="Avatar" width="90"
                                             height="90" />
                                    </figure>
                                    <div class="comment-content">
                                        <h4 class="comment-author font-weight-bold">
                        ...
                        <form class="reply-section pb-4">
                            ...
                            <textarea cols="30" rows="6" placeholder="Write a Comment" class="form-control mb-4"
                                      id="comment"></textarea>
                                                ...
                                                <div class="swiper-wrapper row cols-1">
                                                    <div class="swiper-slide widget-col">
                                                        <div class="post-widget mb-4">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/1.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                                ...
                                                                <h4 class="post-title">
                                                                    <a href="post-single.html">Fashion tells about who
                                                                                               you are from external
                                                                                               point</a>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        <div class="post-widget mb-4">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/2.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                                ...
                                                                <h4 class="post-title">
                                                                    <a href="post-single.html">New found the men dress
                                                                                               for summer</a>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        <div class="post-widget mb-2">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/3.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                    ...
                                                    <div class="swiper-slide widget-col">
                                                        <div class="post-widget mb-4">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/4.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                                ...
                                                                <h4 class="post-title">
                                                                    <a href="post-single.html">Vivamus vestibulum ntulla
                                                                                               nec ante</a>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        <div class="post-widget mb-4">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/5.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                        ...
                                                        <div class="post-widget mb-2">
                                                            <figure class="post-media br-sm">
                                                                <img src="{{ asset('/assets/images/blog/sidebar/6.jpg') }}" alt="150"
                                                                     height="150" />
                                                            </figure>
                                                            <div class="post-details">
                                                                <div class="post-meta">
                                                                ...
                                                                <h4 class="post-title">
                                                                    <a href="post-single.html">Comes a cool blog post
                                                                                               with Images</a>
                                                                </h4>
                                                            </div>
                                                        </div>
