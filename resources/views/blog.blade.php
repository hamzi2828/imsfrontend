        ...
        <div class="swiper-container swiper-theme" data-swiper-options="{
            ...
            <div class="swiper-wrapper row cols-lg-4 cols-md-3 cols-sm-2 cols-1">
                <div class="swiper-slide post text-center overlay-zoom">
                    <figure class="post-media br-sm">
                        <a href="post-single.html">
                            <img src="{{ asset('/assets/images/demos/demo1/blogs/1.jpg') }}" alt="Post"
                                 width="280"
                ...
                <div class="swiper-slide post text-center overlay-zoom">
                    <figure class="post-media br-sm">
                        <a href="post-single.html">
                            <img src="{{ asset('/assets/images/demos/demo1/blogs/2.jpg') }}" alt="Post"
                                 width="280"
                ...
                <div class="swiper-slide post text-center overlay-zoom">
                    <figure class="post-media br-sm">
                        <a href="post-single.html">
                            <img src="{{ asset('/assets/images/demos/demo1/blogs/3.jpg') }}" alt="Post"
                                 width="280"
                ...
                <div class="swiper-slide post text-center overlay-zoom">
                    <figure class="post-media br-sm">
                        <a href="post-single.html">
                            <img src="{{ asset('/assets/images/demos/demo1/blogs/4.jpg') }}" alt="Post"
                                 width="280"
